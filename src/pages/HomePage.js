...
function HomePage() {
  ...
  return (
    <>
      <div className="h-[40vh] bg-primary magenta-madness">Container Landing Image</div>
      <div className="h-[10vh] bg-gradient-to-r from-secondary from-40% to-primary magenta-madness">stock filter</div>
