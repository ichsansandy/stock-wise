...
<br/>
[Video Introduction](https://drive.google.com/file/d/1zgv3pxcXVUncn4oxEeoDmFjToCH-7LNG/view?usp=sharing)
...
```sh
  git clone https://github.com/ichsansandy/stock-wise.git
```
